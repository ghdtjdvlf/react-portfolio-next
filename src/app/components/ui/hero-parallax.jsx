...
import { ShootingStars } from "./Reactbits/ShootingStars/ShootingStars";
import { StarsBackground } from "./Reactbits/ShootingStars/StarsBackground";
...
export const HeroParallax = ({ products }) => {
  ...
  return (
    <div
      ref={ref}
      className="h-[300vh] py-40 overflow-hidden antialiased relative flex flex-col self-auto bg-black text-white [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
